...
rcpp_from_json <- function(json, simplify, na_fill) {
    .Call(`_jsonify_rcpp_from_json`, json, simplify, na_fill)
}
...
rcpp_read_json_file <- function(file, mode, simplify, na_fill, buffer_size = 1024L) {
    .Call(`_jsonify_rcpp_read_json_file`, file, mode, simplify, na_fill, buffer_size)
}
