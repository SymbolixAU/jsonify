...
rcpp_to_json <- function(lst, unbox = FALSE, digits = -1L, numeric_dates = TRUE, stringsAsFactors = FALSE, by = "row") {
    .Call(`_jsonify_rcpp_to_json`, lst, unbox, digits, numeric_dates, stringsAsFactors, by)
}
