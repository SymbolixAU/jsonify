...
I've currently left this up to the user. At its core in R, `Dates` are numeric, so they're treated as numbers when converted to JSON. 

I've given the option to the user to coerce to character through the `numeric_dates` argument. 
